...
export default function Spotify ()
{
    return (
        <div className="border fade">
            ...
            <p className="text-white text-center font-PlayFair text-xl lg:text-2xl my-2">But : Apprendre l'utilisation de React, avec un rendu en Single Page, des appels de components ainsi que l'utilisation d'une API pour un projet</p>
